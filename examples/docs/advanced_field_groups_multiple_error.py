...
try:
    load(
        MergeMetadata(
            sources=(
                ...
                LoadMetadata(file_=SOURCES_DIR / "field_groups_multiple_partial_overrides.yaml"),
            ),
            field_groups=(
    ...
    overrides_path = str(SOURCES_DIR / "field_groups_multiple_partial_overrides.yaml")
