...
# Output:
# [Config] Source 0 loaded: loader=yaml1.2, file=.../defaults.yaml, keys=['host', 'port', 'tags']
# [Config] Source 0 raw data: {'host': 'localhost', 'port': 3000, 'tags': ['default']}
# [Config] Source 1 loaded: loader=yaml1.2, file=.../overrides.yaml, keys=['host', 'port', 'tags']
